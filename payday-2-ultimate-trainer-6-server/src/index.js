...
const AddonsStore = require(path.join(__dirname, "stores", "addons-store.js"));
...
const addonsStore = new AddonsStore(path.join(path.dirname(path.dirname(__dirname)), "addons.json"));
...
const stores = { addonsStore, mainStore, missionStore, settingsStore, spawnStore };;
